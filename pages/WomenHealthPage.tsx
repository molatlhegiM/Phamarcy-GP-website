  ...
  return (
    <div className="py-20 bg-pink-50/30">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
          {[
            ...
            { title: 'Safe Abortions', desc: 'Professional medical procedures available up to 12 weeks gestation.', icon: 'Shield' },
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-white flex flex-col md:flex-row items-center gap-10 overflow-hidden relative">
          <div className="flex-1 relative z-10">
            ...
            <p className="text-slate-400 text-lg mb-10 leading-relaxed">We understand the importance of privacy and sensitive care. Reach out to our team directly through our confidential channel.</p>
      ...
      <ContactModal 
        ...
        title="Confidential Health Enquiry"
        description="Your privacy is our priority. A female health professional will respond to your message discreetly and promptly."
        type="confidential"
      />
    </div>
  );
