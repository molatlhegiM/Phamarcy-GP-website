    ...
    <footer className="bg-slate-950 text-slate-200 py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-8">
              <div className="w-10 h-10 bg-moshate-blue rounded-xl flex items-center justify-center text-white font-bold text-xl">
                M
              </div>
            ...
            <p className="text-slate-400 max-w-sm mb-10 leading-relaxed text-lg">
              Professional healthcare for Akasia families with GP, pharmacy, dental, and physiotherapy services in one trusted centre.
            </p>
            <div className="flex space-x-5">
              <a href={`tel:${PHARMACY_INFO.phone}`} className="w-12 h-12 bg-slate-900 rounded-2xl flex items-center justify-center hover:bg-moshate-blue transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 font-medium">
              ...
              <li><button onClick={() => onNavigate('services')} className="hover:text-emerald-500 transition-colors">Services Overview</button></li>
              <li><button onClick={() => onNavigate('pharmacy')} className="hover:text-emerald-500 transition-colors">Pharmacy</button></li>
          ...
          <div>
            <h4 className="text-white font-bold text-lg mb-8">Centre Info</h4>
            <ul className="space-y-6 text-slate-400 text-sm">
              ...
              <li className="flex gap-4">
                ...
                <span>Mon-Fri: 08:00 - 18:00<br/>Sat: 08:00 - 13:00</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-xs text-slate-600 font-bold tracking-widest gap-6">
          <p className="uppercase">(c) {new Date().getFullYear()} MOSHATE MEDICAL CENTRE. ALL RIGHTS RESERVED.</p>
